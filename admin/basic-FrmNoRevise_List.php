...
<script>
    ...
    //  alert('hellow');
			$("#search").click(function(){
				var start=$("#start").val();
				var end=$("#end").val();  
				$.post("search_FrmNoRevise_list.php",{
					start:start,
					end:end 
				},
				function(output){
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ແບບຟອມຄຳຕົກລົງບໍ່ຮື້ຟື້ນ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ແບບຟອມຄຳຕົກລົງບໍ່ຮື້ຟື້ນ</B></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
               ...
               $i=0;              
               @$start=$_POST['start'];    
               $sql = "SELECT * FROM Civ_NoRevise WHERE Item_Date = '$start'  order by Item_Cnt";
