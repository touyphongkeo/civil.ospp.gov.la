      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຂໍ້ມູນກ່ຽວກັບກົດໝາຍ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"></B>ຂໍ້ມູນກ່ຽວກັບກົດໝາຍ</B></li>
          ...
          <div class="row">
            ...
            <form action="app/add_frmLaw_file.php" name="frmAdd" method="POST" enctype='multipart/form-data'>
            <div class="card mb-0" style='border: 2px solid #057c0c; border-radius: 8px;'>
             <div class="card-header py-0 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="input-group">
                  <div class="col-lg-3">
                  <lable>ລະຫັດ</lable>
                  <input type="text" class="form-control" id="Law_IDd"  placeholder="ລະຫັດ"  name="Law_ID" required>
                  </div>
