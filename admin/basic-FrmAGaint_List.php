      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຄຳສະເໜີຄັດຄ້ານ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຄຳສະເໜີຄັດຄ້ານ</li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $i=0;              
                @$start=$_POST['start'];    
                $sql = "SELECT * FROM Civ_Againt WHERE Item_Date = '$start'  order by Item_Cnt";
