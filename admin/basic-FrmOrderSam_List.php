...
<script>
     ...
     //   alert(start);
				$.post("search_frmOrderSam_list.php",{
					start:start,
					end:end
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ໃບສະເໜີທວງສໍານວນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ໃບສະເໜີທວງສໍານວນ</li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $sql = "SELECT * FROM CriSam_Order WHERE Item_Date = '$start'  order by item_Cnt";
