      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <?php
             ...
             $stmt = "SELECT * FROM Civ_Users WHERE Usr_id = ? ";   
             $query = sqlsrv_query( $conn, $stmt, $Usr_id);
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <form action="update_users_crm.php" name="frmAdd" method="POST">

                    <div class="form-group">
                      <label for="Usr_id">ລະຫັດເຂົ້າໂປຣແກຣມ</label>
                      <input type="text" readonly class="form-control" id="Usr_id" name="Usr_id" aria-describedby="Usr_id" value="<?php echo $result["Usr_id"];?>">
                    </div>

                    <div class="form-group">
                      <label for="PWD">ລະຫັດຜ່ານ</label>
                      <input type="password" class="form-control" id="PWD" name = "PWD" value="<?php echo $result["PWD"];?>">
                    </div>
                   

                    <div class="form-group">
                      <label for="Person_ID">ລະຫັດຜູ້ໃຊ້</label>
                      <input type="password" class="form-control" id="Person_ID " name = "Person_ID" value="<?php echo $result["Person_ID"];?>">
                    </div>

                    <div class="form-group">
                      <label for="Sec_id">ລະຫັດອົງກອນ</label>
                      <input type="password" class="form-control" id="Sec_id" name = "Sec_id" value="<?php echo $result["Sec_id"];?>">
                    </div>
              ...
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Usr_nm" name="Usr_nm"   value="<?php echo $result["Usr_nm"];?>">
                    </div>
                    ...
                    <div class="form-group">
                     <label>ການໃຫ້ສິດທິ</label>
                      ...
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="Write_bit" name = "Write_bit" onclick="Write_bit()"   
                          <?php 
                          if($result['Write_bit']=='1') {
                             echo 'checked';
                             }else{
                                 echo '';
                             }?>>
                      ...
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="Edit_bit" name = "Edit_bit" onclick="Edit_bit()"   
                          <?php 
                          if($result['Edit_bit']=='1') {
                             echo 'checked';
                             }else{  
                              echo '';
                             }?>>
                      ...
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="Delete_bit" name = "Delete_bit" onclick="Delete_bit()"   
                          <?php 
                          if($result['Delete_bit']=='1') {
                             echo 'checked';
                             }else{  
                              echo '';
                             }?>>
                      ...
                      <a href='../basic-FrmUser.php' class="btn btn-danger" onclick="window.exit();">ກັບຄືນ</a>
                  </form>
