      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຂໍ້ມູນກ່ຽວກັບກົດໝາຍ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຂໍ້ມູນກ່ຽວກັບກົດໝາຍ</li>
          ...
          <?php
             ...
             $stmt = "SELECT * FROM Civ_Law_files WHERE Law_ID = ? ";   
          ...
          <div class="row">
            ...
            <form action="Usaved_Lawfile.php" name="frmAdd" method="POST"  enctype='multipart/form-data'>
            <div class="card mb-0" style='border: 2px solid #057c0c; border-radius: 8px;'>
             <div class="card-header py-0 d-flex flex-row align-items-center justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">ບັນທືກ</button>
                 <a href='../basic-FrmLaw_Files.php' class="btn btn-success" onclick="window.exit();">ກັບຄືນ</a>
                </div>
                </div>
                </form>
                </div><br>
