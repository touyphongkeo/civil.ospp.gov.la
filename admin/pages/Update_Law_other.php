      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <?php
             ...
             $stmt = "SELECT * FROM Civ_Law_files_Other WHERE Law_ID = ? ";   
          ...
          <div class="row">
            ...
            <form action="Usaved_Lawother.php" name="frmAdd" method="POST"  enctype='multipart/form-data'>
            <div class="card mb-0" style='border: 2px solid #057c0c; border-radius: 8px;'>
             <div class="card-header py-0 d-flex flex-row align-items-center justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">ບັນທືກ</button>
                 <a href='../basic-FrmLaw_Files_Other.php' class="btn btn-success">ກັບຄືນ</a>
                </div>
                </div>
                </form>
                </div><br>
