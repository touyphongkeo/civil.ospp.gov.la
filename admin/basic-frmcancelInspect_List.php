...
<script>
     ...
     //   alert(start);
				$.post("search_frmcancelInspect_List.php",{
					start:start,
					end:end,
          Item_No:Item_No,
          Item_ID:Item_ID
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຂາອອກຄະດີແພ່ງ, ການຄ້າ, ຄອບຄົວ ແລະ ເດັກ ຂັ້ນຕິດຕາມກວດກາ</B></h5>

            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຂາອອກຄະດີແພ່ງ, ການຄ້າ, ຄອບຄົວ ແລະ ເດັກ ຂັ້ນຕິດຕາມກວດກາ</li>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $sql = " SELECT * FROM Civ_CancelInspect WHERE Item_Date = '$start'  order by item_Cnt";
                ...
                ?>
                    <tbody id="users">
                        ...
                        <td><?PHP echo $result["Item_Datesam"]; ?></td>
