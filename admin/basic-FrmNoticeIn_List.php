      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຕິດຕາມຂາອອກການແກ້ໄຂແຈ້ງການຂອງສະພາແຫ່ງຊາດ ແລະ ອື່ນໆ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຕິດຕາມຂາອອກການແກ້ໄຂແຈ້ງການຂອງສະພາແຫ່ງຊາດ ແລະ ອື່ນໆ</B></li>
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                <?php
                  ...
                  $sql = "SELECT * FROM Civ_ReportDetail WHERE Item_Date = '$start'  order by Item_Cnt";
