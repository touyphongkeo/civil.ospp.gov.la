...
<script>
     ...
     //   alert(start);
				$.post("search_FrmInspectIn_List.php",{
					start:start,
					end:end,
          Item_ID:Item_ID,
          Item_No:Item_No
      ...
      <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຕິດຕາມຂາເຂົ້າຄຳຮ້ອງຂໍຕິດຕາມກວດກາ<B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຕິດຕາມຂາເຂົ້າຄຳຮ້ອງຂໍຕິດຕາມກວດກາ<B></li>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <?php
                ...
                $sql = " SELECT * FROM Civ_Inspect_In WHERE Item_Date = '$start'  order by item_Cnt";
