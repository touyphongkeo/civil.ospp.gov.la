...
<script>
     ...
     // alert(start);
        ...
        var In_No=$("#In_No").val();
     //   alert(start);
				$.post("search_frmrequesttrueout_List.php",{
					start:start,
					end:end,
          Item_ID:Item_ID,
          In_No:In_No
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຂາອອກຄຳຮ້ອງຂໍຮື້ຟື້ນ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຂາອອກຄຳຮ້ອງຂໍຮື້ຟື້ນ</B></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $sql = "SELECT * FROM Civ_ReQuestTrueOut WHERE Item_Date = '$start'  order by item_Cnt";
