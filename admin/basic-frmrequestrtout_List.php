...
<script>
     ...
     //   alert(start);
				$.post("search_frmrequestrtout_List.php",{
					start:start,
					end:end,
          Item_ID:Item_ID,
          Item_No:Item_No
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຄຳຮ້ອງຂໍລົບລ້າງ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຄຳຮ້ອງຂໍລົບລ້າງ</B></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $sql = " SELECT * FROM Civ_ReQuestRetOutee WHERE Item_Date = '$start'  order by item_Cnt";
