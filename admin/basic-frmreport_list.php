...
<script>
    ...
    //  alert('hellow');
        ...
        var Item_No=$("#Item_No").val();
				$.post("search_frmReportIn_list.php",{
					start:aa,
					end:bb,
          Item_ID:Item_ID,
          Item_No:Item_No
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຕິດຕາມຂາເຂົ້າຂໍ້ຕົກລົງຂອງສະພາ ແລະ ໜັງສືລັດຖະການ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຕິດຕາມຂາເຂົ້າຂໍ້ຕົກລົງຂອງສະພາ ແລະ ໜັງສືລັດຖະການ</B></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $sql = "SELECT * FROM Civ_Report WHERE Item_Date = '$start'  order by Item_Cnt";
