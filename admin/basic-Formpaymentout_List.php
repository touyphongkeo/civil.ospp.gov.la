...
<script>
     ...
     // alert(start);
      ...
      //  alert(start);
				$.post("search_formpaymentout_list.php",{
					start:start,
					end:end,
          Item_ID:Item_ID,
          Item_No:Item_No
      ...
      <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ທວງສຳນວນຄະດີ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ທວງສຳນວນຄະດີ</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $sql = " SELECT * FROM Civ_CheckOutmeok WHERE Item_Date = '$start'  order by item_Cnt";
