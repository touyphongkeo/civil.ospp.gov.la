...
<script>
     ...
     //   alert(start);
				$.post("search_rmrequesttruequt-list-load.php",{
					start:start,
					end:end,
          Item_ID:Item_ID,
          In_No:In_No
      ...
      <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຂາອອກຄຳຮ້ອງຂໍຄວາມເປັນທຳ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຂາອອກຄຳຮ້ອງຂໍຄວາມເປັນທຳ</li>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                $sql = " SELECT * FROM Cri_ReQuestTrueOut WHERE Item_Date = '$start'  order by item_Cnt";
