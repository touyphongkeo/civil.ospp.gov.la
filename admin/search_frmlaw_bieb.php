<html>
	<body>
             ...
             <div id='show' class="table-responsive p-10">
                ...
                if($Law_ID==""){$Law_ID="";}
                else{ $Law_ID="and (Civ_Law_files_Labieb.Law_ID like N'%$Law_ID%' or Civ_Law_files_Labieb.Law_ID like N'$Law_ID%')";}

        


                $i=1;
                $sql = "select *from Civ_Law_files_Labieb where 1=1 $Law_ID";
