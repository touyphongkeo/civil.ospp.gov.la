<html>
	<body>
             ...
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and Civ_ReQuestOutkeo.Item_Date between '$start' and '$end'";}


              

                if($Item_No==""){$b="";}
                else{ $b="and (Civ_ReQuestOutkeo.Item_No like N'%$Item_No%' or Civ_ReQuestOutkeo.Item_No like N'$Item_No%')";}

                if($Item_ID==""){$d="";}
                else{ $d="and (Civ_ReQuestOutkeo.Item_ID like N'%$Item_ID%' or Civ_ReQuestOutkeo.Item_ID like N'$Item_ID%')";}

               


                $i=1;
                $sql = "select *from Civ_ReQuestOutkeo where 1=1 $btw $b $d order by Civ_ReQuestOutkeo.item_Cnt asc";
