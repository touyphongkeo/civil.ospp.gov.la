<html>
	<body>
             ...
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and Civ_CheckIn.Item_Date between '$start' and '$end'";}


                if($Item_ID==""){$b="";}
                else{ $b="and (Civ_CheckIn.Item_ID like N'%$Item_ID%' or Civ_CheckIn.Item_ID like N'$Item_ID%')";}

                if($Item_No==""){$d="";}
                else{ $d="and (Civ_CheckIn.Item_No like N'%$Item_No%' or Civ_CheckIn.Item_No like N'$Item_No%')";}

                $i=1;
                $sql = "select *from Civ_CheckIn where 1=1 $btw $b $d order by Civ_CheckIn.item_Cnt asc";
