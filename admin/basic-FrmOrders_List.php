...
<script>
    ...
    //  alert('hellow');
			$("#search").click(function(){
				...
				$.post("search_FrmOrders_list.php",{
					start:start,
					end:end
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ແບບຟອມໜັງສືແຈ້ງຕອບ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ແບບຟອມໜັງສືແຈ້ງຕອບ</li>
            ...
            <div class="col-lg-12">
              <div class="card mb-0">
                ...
                <?php
                  ...
                  $i=0;              
                  @$start=$_POST['start'];    
                  $sql = "SELECT * FROM Cri_Orders WHERE Item_Date = '$start'  order by Item_Cnt";
